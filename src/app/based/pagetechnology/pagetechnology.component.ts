...
@Component({
  selector: 'app-pagetechnology',
  templateUrl: './pagetechnology.component.html',
  styleUrls: ['./pagetechnology.component.css']
})
export class PagetechnologyComponent implements OnInit {
  @Input()
